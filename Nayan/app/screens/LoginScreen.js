...
export default function LoginScreen({ navigation }) {
  ...
  const [request, response, promptAsync] = Google.useAuthRequest({
    androidClientId: '692053753746-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.apps.googleusercontent.com',
    webClientId: '112684681132-jd55r444enk8c7gm5cutt9olhtp87o9t.apps.googleusercontent.com',
    expoClientId: '692053753746-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.apps.googleusercontent.com',
  });
  ...
  const handleLogin = async () => {
    // For now, allow login without validation for demo purposes
    setTimeout(() => {
      navigation.navigate('Dash');
    }, 200);
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.titleContainer}>
        ...
        <Text style={styles.title}>Nayan</Text>
      </View>

      <Text style={styles.welcome}>Welcome to Nayan</Text>
